...
Human Validation Zone from docs/SAFETY_BOUNDARIES.md expressed as an API shape rather than
...
def _run_optout(broker: str, target: dict, proxy_email: str) -> None:
    ...
    gitignored precisely because it must not accumulate PII (docs/SAFETY_BOUNDARIES.md), and a
