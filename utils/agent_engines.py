...
`dry_run=False`, docs/SAFETY_BOUNDARIES.md designates submission a Human Validation Zone,
...
class VerificationEngine:
    ...
    def verify_removal(self, removal_id: int) -> Optional[bool]:
        ...
        See docs/SAFETY_BOUNDARIES.md: a verification that could not be completed is recorded
