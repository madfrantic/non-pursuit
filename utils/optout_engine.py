...
the same Human Validation Zone the rest of this app enforces (docs/SAFETY_BOUNDARIES.md): an
...
def execute_optout(broker_id: str, target_data: dict, proxy_email: str,
    ...
    if not dry_run:
        return {"status": "error",
                "error": "Live submission is not implemented; see docs/SAFETY_BOUNDARIES.md Human "
